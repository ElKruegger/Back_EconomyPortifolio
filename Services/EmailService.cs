...
namespace EconomyBackPortifolio.Services
{
    public class EmailService : IEmailService
    {
        ...
        private static (string Subject, string HtmlBody) BuildEmailContent(string userName, string code, VerificationCodeType type)
        {
            ...
            {
                VerificationCodeType.Login => ("Código de Login", "Utilize o código abaixo para concluir seu login:"),
                VerificationCodeType.Registration => ("Confirme seu Cadastro", "Utilize o código abaixo para confirmar seu cadastro:"),
                VerificationCodeType.PasswordReset => ("Redefinição de Senha", "Utilize o código abaixo para redefinir sua senha:"),
    ...
    <table width=""100%"" cellpadding=""0"" cellspacing=""0"" style=""background-color:#f4f4f7;padding:40px 0;"">
        <tr><td align=""center"">
            <table width=""480"" cellpadding=""0"" cellspacing=""0"" style=""background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);"">
                ...
                <tr><td style=""background-color:#f9f9fb;padding:16px 32px;text-align:center;border-top:1px solid #eee;"">
